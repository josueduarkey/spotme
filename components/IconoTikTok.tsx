...
/**
 * Logo de TikTok (variante "light", para fondos claros) — paths exactos de
 * assets/tiktok-icon-light.svg, como componente porque Metro no importa .svg
 * sin transformer y react-native-svg ya viene en el APK.
 */
export function IconoTikTok({ size = 22 }: Props) {
  return (
    <Svg width={size} height={size * (398.67 / 352.28)} viewBox="0 0 352.28 398.67">
      <Path
        fill="#25f4ee"
